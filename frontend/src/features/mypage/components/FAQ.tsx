...
export const FAQ: React.FC = () => {
  ...
  const [faqs] = useState<FAQItem[]>([
    ...
    },
    {
      ...
      answer: '아동복지카드는 정부에서 아동의 건강한 성장을 지원하기 위해 제공하는 복지 서비스입니다. 만 18세 미만 아동에게 월 일정 금액을 지원하여 식품비, 의료비, 교육비 등에 사용할 수 있습니다. 소득 기준을 충족하는 과정에서 신청 가능하며, 읍면동 주민센터나 온라인을 통해 신청할 수 있습니다. 카드 사용 내역은 모바일 앱이나 웹사이트에서 확인할 수 있으며, 아동의 건강한 식습관 형성과 영양 개선에 도움이 됩니다.\n☎️ 문의전화 : 129 (보건복지상담센터)\n🌐 관련사이트 : www.bokjiro.go.kr (복지로)\n📱 모바일앱 : 복지로 앱\n🏢 신청장소 : 거주지 읍면동 주민센터'
    },
    {
      id: '2',
    ...
    {
      id: '4',
      question: '매장 목록에서 왜 편의점만 보이나요?',
      answer: '아동급식카드는 지역별로 사용이 제한되어 있으며, 전국 어디서나 사용할 수 있는 가맹점은 편의점뿐이기 때문에 거주지 외 지역에서는 편의점 목록만 표시됩니다.'
    },
    {
      id: '5',
